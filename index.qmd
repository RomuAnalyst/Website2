...
<p class="card-text">{{< fa solid calendar >}} Prendre rendez-vous (cours particuliers)</p>
<div style="margin-top: auto;"><a href=https://cal.com/romuanalyst class="card-link third-color-link heading-font">Prendre rendez-vous</a></div>
</div>
</div>
:::
::: {.g-col-12 .g-col-md-4}
